...
void main(){
    ...
    vec3 specularity = pow(max(0.0, dot(R, V)), p3d_Material.shininess) * p3d_Material.specular;
    
    color = vec4(diffusion + specularity + Ambience, 1.0);
}

/*
    This is a more accurate but a little slower to calculate than with the blinn-optimization. Not by much but a bit.
*/